...
//        $alergias = $request->get('alergias');
	 ...
	 */
        ...
        $patologicos = $request->get('patologicos');
        $hereditarios= $request->get('hereditarios');
        $noPatologicos = $request->get('noPatologicos');
        $medicamentoAlergias = $request->get('medicamentosAlergias');
        $tabaquismo= $request->get('tabaquismo');
        $alcoholismo= $request->get('alcoholismo');
        
//        var_dump($tabaquismo);
//        var_dump($alcoholismo);
        ...
        if(count($paciente)!=0){
            ...
            $paciente->setHereditarios($hereditarios);
            $paciente->setNoPatologicos($noPatologicos);
            $paciente->setMedicamentosAlergias($medicamentoAlergias);
            $paciente->setTabaquismo($tabaquismo);
            $paciente->setAlcoholismo($alcoholismo);
